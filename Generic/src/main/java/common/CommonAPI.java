...
public class CommonAPI {
    ...
    public String browserstack_username = "faizhamid1";
    public String browserstack_accesskey = "3LypvGypSVpfVWyxXFpQ";
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("OS X") String os, @Optional("10") String os_version, @Optional("chrome-options") String browserName, @Optional("38")
                              String browserVersion, @Optional("http://www.macys.com") String url) throws IOException {
//        System.setProperty("webdriver.chrome.driver", "/Users/faizhamid/Documents/Group2SeleniumProject/Generic/src/main/java/driver/chromedriver");
        if (useCloudEnv == true) {
